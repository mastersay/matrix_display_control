...
#line 1 "C:/Users/japru/Desktop/School/Third_year/Prax/Matrix_display_control/Matrix_display_control_code/main.ino"
...
#line 23 "C:/Users/japru/Desktop/School/Third_year/Prax/Matrix_display_control/Matrix_display_control_code/cmake-build-debug/Matrix_display_control_code_main.ino.cpp"
#include "Arduino.h"

//=== START Forward: C:/Users/japru/Desktop/School/Third_year/Prax/Matrix_display_control/Matrix_display_control_code/main.ino
 void setup() ;
 void setup() ;
 void loop() ;
 void loop() ;
 ...
 void display_string2(String text) ;
//=== END Forward: C:/Users/japru/Desktop/School/Third_year/Prax/Matrix_display_control/Matrix_display_control_code/main.ino
#line 19 "C:/Users/japru/Desktop/School/Third_year/Prax/Matrix_display_control/Matrix_display_control_code/main.ino"
...
byte alphabet[][5] = {
        ...
        {0xC9, 0xB6, 0xB6, 0xB6, 0x80},
        {0xBE, 0xBE, 0xBE, 0xBE, 0xC1},
        {0xC1, 0xBE, 0xBE, 0xBE, 0x80},
        {0xBE, 0xB6, 0xB6, 0xB6, 0x80},
        {0xFE, 0xF6, 0xF6, 0xF6, 0x80},
        {0xCD, 0xAE, 0xBE, 0xBE, 0xC1},
        {0x80, 0xF7, 0xF7, 0xF7, 0x80},
        {},
        {},
        {},
        {0xBF, 0xBF, 0xBF, 0xBF, 0x80},
        {},
        {},
        {0xC1, 0xBE, 0xBE, 0xBE, 0xC1}

};
byte A[] = {0x81, 0xEE, 0xEE, 0xEE, 0x81};
byte B[] = {0xC9, 0xB6, 0xB6, 0xB6, 0x80};
byte C[] = {0xBE, 0xBE, 0xBE, 0xBE, 0xC1};
byte D[] = {0xC1, 0xBE, 0xBE, 0xBE, 0x80};
byte E[] = {0xBE, 0xB6, 0xB6, 0xB6, 0x80};
byte F[] = {0xFE, 0xF6, 0xF6, 0xF6, 0x80};
byte G[] = {0xCD, 0xAE, 0xBE, 0xBE, 0xC1};
byte H[] = {0x80, 0xF7, 0xF7, 0xF7, 0x80};


byte alphabet2[][5] = {
        {0x80, 0x7B, 0x7B, 0x7B, 0x80},
        {0x0,  0x0,  0x0,  0x0,  0x0},
        {0x0,  0x0,  0x0,  0x0,  0x0},
        {0x0,  0x0,  0x0,  0x0,  0x0},
        {0x0,  0x0,  0x0,  0x0,  0x0},
...
void loop() {
    //String text2 = "AAABB";
    char text[] = "!\"#$%&'()*+,-./0123456789:;<=>?ABCDEFGHAB!!!!!";
...
//                        {0x80, 0x80, 0x80, 0x80, 0x80},
//                        {0x80, 0x80, 0x80, 0x80, 0x80}};
    float text_size_rounds = ((float) strlen(text)) / 5.0;
    byte sizer = 0;
...
//        sizer++;
        for (int j = 4; j >= 0; --j) {
            buffer[sizer] = alphabet[text[i]][j];
            sizer++;
        }
...
//            for (int k = 0; k <=i; ++k) {
        ...
        for (byte i = 0; i < 5; ++i) {
            for (int j = 4; j >= 0; --j) {
                buffer[sizer] = alphabet[text[i + 5 * increaser]][j];
                sizer++;
            }
        }
